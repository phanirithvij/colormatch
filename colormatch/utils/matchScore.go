...
// func MatchScore(data, p2) float64 {
//     if data.is_a? Photo {
// 		// Don"t even bother with B&W photos if our photo isnt B&W
// 		if p2.stat.hsb["s"]["mean"] < 10 && data.stat.hsb["s"]["mean"] > 10	{
// 			return 0
// 		}
...
// }
// func by_threshold_num_of_matches(p1, p2){
//     matching_colours = []
...
//     end
// }
// func by_saturation_and_common(p1, p2){
...
// func get_most_common(colours) []color.Color {
//     return colours.sort { |a, b|  b.coverage <=> a.coverage }.first
// }

// func get_most_saturated(colours){
//     colours.sort { |a, b|  (b.hsb["s"] + b.hsb["b"] * 0.75) <=> (a.hsb["s"] + a.hsb["b"] * 0.75) }.first
// }

// func normalized_dist(c1, c2){
//     dist  = Calculate::Distance.call(c1, c2)
//     Calculate::NormalizedDistance.call(dist).round(2)
// }

// func get_nearest_colour(c1, colours){
//     closest_color = nil
